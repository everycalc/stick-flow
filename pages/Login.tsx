...
const Login: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-light-background dark:bg-dark-background flex flex-col justify-center items-center p-4">
            <h1 className="text-3xl sm:text-4xl text-light-text dark:text-dark-text mb-6 font-bold tracking-wider text-light-primary dark:text-dark-primary">Stickflow</h1>
            <div className="bg-light-surface dark:bg-dark-surface p-6 sm:p-8 rounded-2xl shadow-lg w-full max-w-sm">
                <h2 className="text-xl font-semibold text-center mb-2">Enter Your PIN</h2>
