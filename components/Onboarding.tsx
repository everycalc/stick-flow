    ...
    return (
        <div className="min-h-screen bg-light-background dark:bg-dark-background flex flex-col justify-center items-center p-4">
            <div className="bg-light-surface dark:bg-dark-surface p-6 sm:p-8 rounded-2xl shadow-lg w-full max-w-md text-center">
                ...
                <p className="text-light-text-secondary dark:text-dark-text-secondary mb-8">{t('onboarding.enter_company')}</p>

                <form onSubmit={handleSubmit}>
                    <div className="space-y-6">
                        <div>
                            <label className="text-sm font-medium text-light-text-secondary dark:text-dark-text-secondary mb-2 block">{t('onboarding.company_name')}</label>
                            <input 
                                type="text" 
                                value={companyName} 
                ...
                <div className="relative my-6">
                    ...
                    <div className="relative flex justify-center">
                        <span className="bg-light-surface dark:bg-dark-surface px-2 text-sm text-light-text-secondary dark:text-dark-text-secondary">{t('login.or')}</span>
                    </div>
                </div>
